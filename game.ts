...
export type DungeonTier = 'beginner' | 'intermediate' | 'advanced' | 'super' | 'extreme' | 'volcano' | 'gemraid' | 'cosmic' | 'infinite';
...
export interface MonsterMaster {
  ...
  traits?: string[];
  moveBehavior?: string;  // 位置システム：aggressive/ranged/evasive/flying/static/circling/erratic
...
export interface PlayerData {
  ...
  claimedTutorials?: string[];                      // ver3.3.0: 各タブのチュートリアル（お試しセット）受け取り済みID一覧
}
