...
export const VERSION_PATCHES = [
  {
    ...
    date: '2025-06',
    changes: [
      '🎲 チンチロリン・ソロプレイをNPC対戦形式に完全リニューアル！先攻決めダイスロール→交互投擲→役の強さで勝敗判定',
      '⚡ チンチロ即勝ち役（ピンゾロ×5倍・アラシ×3倍・シゴロ×2倍）が正しく即時発動し支払いが発生するように',
      '🤝 チンチロ両者役なし時は引き分けで返金されるように修正',
      '🪙 コイントスを「チキンレース（ダブル・オア・ナッシング）」形式に刷新！当たるたびに倍率倍増、外れたら没収',
      '🔁 コイントス：「確定（Bank）」か「続行（Double）」を自分で選べる中毒性の高いシステムに変更',
    ],
  },
  {
    version: '2.3.0',
    date: '2025-06',
    changes: [
      '⚔️ PvP対戦（丁半・チンチロ・コイントス・スロット）の演出を両プレイヤーで完全同期',
      '🎲 先攻決めダイス目・サイコロの出目・コインの表裏・スロットのリール結果がサーバー側で一括生成され、全員が同じ演出を同じ順序で閲覧可能に',
      '🔧 以前は対戦開始後に両プレイヤーの画面が別々の展開になるバグを修正',
    ],
  },
  {
    version: '2.2.0',
