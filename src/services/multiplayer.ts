...
export const STOCK_MASTERS: Record<StockId, StockMaster> = {
  ...
  wealth_ai: { id: 'wealth_ai', name: 'Wealth AI', icon: '🤖', basePrice: 2600, sector: 'tech', sharesOutstanding: 120000000, splitThreshold: 15600 },
  wealth_chip: { id: 'wealth_chip', name: 'Wealth Chip', icon: '💾', basePrice: 2400, sector: 'tech', sharesOutstanding: 120000000, splitThreshold: 14400 },
  wealth_cloud: { id: 'wealth_cloud', name: 'Wealth Cloud', icon: '☁️', basePrice: 1800, sector: 'tech', sharesOutstanding: 120000000, splitThreshold: 10800 },
  wealth_cyber: { id: 'wealth_cyber', name: 'Wealth Cyber', icon: '🛡️', basePrice: 1500, sector: 'tech', sharesOutstanding: 120000000, splitThreshold: 9000 },
  wealth_bio: { id: 'wealth_bio', name: 'Wealth Bio', icon: '🧬', basePrice: 1400, sector: 'tech', sharesOutstanding: 120000000, splitThreshold: 8400 },
  wealth_quantum: { id: 'wealth_quantum', name: 'Wealth Quantum', icon: '⚛️', basePrice: 3200, sector: 'tech', sharesOutstanding: 120000000, splitThreshold: 19200 },
  wealth_drone: { id: 'wealth_drone', name: 'Wealth Drone', icon: '🛸', basePrice: 1100, sector: 'tech', sharesOutstanding: 120000000, splitThreshold: 6600 },
  wealth_semicon: { id: 'wealth_semicon', name: 'Wealth Semicon', icon: '💠', basePrice: 2100, sector: 'tech', sharesOutstanding: 120000000, splitThreshold: 12600 },
  wealth_construction: { id: 'wealth_construction', name: 'Wealth Construction', icon: '🏗️', basePrice: 1200, sector: 'industry', sharesOutstanding: 120000000, splitThreshold: 7200 },
  wealth_machinery: { id: 'wealth_machinery', name: 'Wealth Machinery', icon: '⚙️', basePrice: 900, sector: 'industry', sharesOutstanding: 120000000, splitThreshold: 5400 },
  wealth_ports: { id: 'wealth_ports', name: 'Wealth Ports', icon: '⚓', basePrice: 800, sector: 'industry', sharesOutstanding: 120000000, splitThreshold: 5000 },
  wealth_tools: { id: 'wealth_tools', name: 'Wealth Tools', icon: '🧰', basePrice: 700, sector: 'industry', sharesOutstanding: 120000000, splitThreshold: 5000 },
  wealth_aerospace: { id: 'wealth_aerospace', name: 'Wealth Aerospace', icon: '🚀', basePrice: 2000, sector: 'industry', sharesOutstanding: 120000000, splitThreshold: 12000 },
  wealth_materials: { id: 'wealth_materials', name: 'Wealth Materials', icon: '🧱', basePrice: 650, sector: 'industry', sharesOutstanding: 120000000, splitThreshold: 5000 },
  wealth_metals: { id: 'wealth_metals', name: 'Wealth Metals', icon: '🔩', basePrice: 850, sector: 'industry', sharesOutstanding: 120000000, splitThreshold: 5100 },
  wealth_trucking: { id: 'wealth_trucking', name: 'Wealth Trucking', icon: '🚛', basePrice: 600, sector: 'industry', sharesOutstanding: 120000000, splitThreshold: 5000 },
  wealth_bank: { id: 'wealth_bank', name: 'Wealth Bank', icon: '🏦', basePrice: 1600, sector: 'finance', sharesOutstanding: 120000000, splitThreshold: 9600 },
  wealth_payments: { id: 'wealth_payments', name: 'Wealth Payments', icon: '💳', basePrice: 1900, sector: 'finance', sharesOutstanding: 120000000, splitThreshold: 11400 },
  wealth_asset: { id: 'wealth_asset', name: 'Wealth Asset', icon: '📊', basePrice: 1400, sector: 'finance', sharesOutstanding: 120000000, splitThreshold: 8400 },
  wealth_brokerage: { id: 'wealth_brokerage', name: 'Wealth Brokerage', icon: '📈', basePrice: 1200, sector: 'finance', sharesOutstanding: 120000000, splitThreshold: 7200 },
  wealth_insurtech: { id: 'wealth_insurtech', name: 'Wealth Insurtech', icon: '🧾', basePrice: 1300, sector: 'finance', sharesOutstanding: 120000000, splitThreshold: 7800 },
  wealth_reit: { id: 'wealth_reit', name: 'Wealth REIT', icon: '🏢', basePrice: 1700, sector: 'finance', sharesOutstanding: 120000000, splitThreshold: 10200 },
  wealth_leasing: { id: 'wealth_leasing', name: 'Wealth Leasing', icon: '🚗', basePrice: 1000, sector: 'finance', sharesOutstanding: 120000000, splitThreshold: 6000 },
  wealth_vc: { id: 'wealth_vc', name: 'Wealth VC', icon: '💼', basePrice: 2200, sector: 'finance', sharesOutstanding: 120000000, splitThreshold: 13200 },
  wealth_beverage: { id: 'wealth_beverage', name: 'Wealth Beverage', icon: '🥤', basePrice: 650, sector: 'consumer', sharesOutstanding: 120000000, splitThreshold: 5000 },
  wealth_snack: { id: 'wealth_snack', name: 'Wealth Snack', icon: '🍪', basePrice: 700, sector: 'consumer', sharesOutstanding: 120000000, splitThreshold: 5000 },
  wealth_cosmetic: { id: 'wealth_cosmetic', name: 'Wealth Cosmetic', icon: '💄', basePrice: 900, sector: 'consumer', sharesOutstanding: 120000000, splitThreshold: 5400 },
  wealth_appliance: { id: 'wealth_appliance', name: 'Wealth Appliance', icon: '🧺', basePrice: 1000, sector: 'consumer', sharesOutstanding: 120000000, splitThreshold: 6000 },
  wealth_homegoods: { id: 'wealth_homegoods', name: 'Wealth Homegoods', icon: '🛋️', basePrice: 850, sector: 'consumer', sharesOutstanding: 120000000, splitThreshold: 5100 },
  wealth_toys: { id: 'wealth_toys', name: 'Wealth Toys', icon: '🧸', basePrice: 750, sector: 'consumer', sharesOutstanding: 120000000, splitThreshold: 5000 },
  wealth_books: { id: 'wealth_books', name: 'Wealth Books', icon: '📚', basePrice: 600, sector: 'consumer', sharesOutstanding: 120000000, splitThreshold: 5000 },
  wealth_drugstore: { id: 'wealth_drugstore', name: 'Wealth Drugstore', icon: '🧴', basePrice: 800, sector: 'consumer', sharesOutstanding: 120000000, splitThreshold: 5000 },
  wealth_stream: { id: 'wealth_stream', name: 'Wealth Stream', icon: '📺', basePrice: 1400, sector: 'entertainment', sharesOutstanding: 120000000, splitThreshold: 8400 },
  wealth_music: { id: 'wealth_music', name: 'Wealth Music', icon: '🎵', basePrice: 1100, sector: 'entertainment', sharesOutstanding: 120000000, splitThreshold: 6600 },
  wealth_esports: { id: 'wealth_esports', name: 'Wealth Esports', icon: '🕹️', basePrice: 2000, sector: 'entertainment', sharesOutstanding: 120000000, splitThreshold: 12000 },
  wealth_themepark: { id: 'wealth_themepark', name: 'Wealth Themepark', icon: '🎢', basePrice: 1800, sector: 'entertainment', sharesOutstanding: 120000000, splitThreshold: 10800 },
  wealth_film: { id: 'wealth_film', name: 'Wealth Film', icon: '🎬', basePrice: 1600, sector: 'entertainment', sharesOutstanding: 120000000, splitThreshold: 9600 },
  wealth_live: { id: 'wealth_live', name: 'Wealth Live', icon: '🎤', basePrice: 900, sector: 'entertainment', sharesOutstanding: 120000000, splitThreshold: 5400 },
  wealth_tickets: { id: 'wealth_tickets', name: 'Wealth Tickets', icon: '🎟️', basePrice: 1000, sector: 'entertainment', sharesOutstanding: 120000000, splitThreshold: 6000 },
  wealth_idol: { id: 'wealth_idol', name: 'Wealth Idol', icon: '✨', basePrice: 1300, sector: 'entertainment', sharesOutstanding: 120000000, splitThreshold: 7800 },
  wealth_gas: { id: 'wealth_gas', name: 'Wealth Gas', icon: '🔥', basePrice: 850, sector: 'energy', sharesOutstanding: 120000000, splitThreshold: 5100 },
  wealth_grid: { id: 'wealth_grid', name: 'Wealth Grid', icon: '⚡', basePrice: 1000, sector: 'energy', sharesOutstanding: 120000000, splitThreshold: 6000 },
  wealth_battery: { id: 'wealth_battery', name: 'Wealth Battery', icon: '🔋', basePrice: 1500, sector: 'energy', sharesOutstanding: 120000000, splitThreshold: 9000 },
  wealth_wind: { id: 'wealth_wind', name: 'Wealth Wind', icon: '🌬️', basePrice: 950, sector: 'energy', sharesOutstanding: 120000000, splitThreshold: 5700 },
  wealth_hydrogen: { id: 'wealth_hydrogen', name: 'Wealth Hydrogen', icon: '🫧', basePrice: 1700, sector: 'energy', sharesOutstanding: 120000000, splitThreshold: 10200 },
  wealth_nuclear: { id: 'wealth_nuclear', name: 'Wealth Nuclear', icon: '☢️', basePrice: 2500, sector: 'energy', sharesOutstanding: 120000000, splitThreshold: 15000 },
  wealth_storage: { id: 'wealth_storage', name: 'Wealth Storage', icon: '🪫', basePrice: 1200, sector: 'energy', sharesOutstanding: 120000000, splitThreshold: 7200 },
  wealth_geo: { id: 'wealth_geo', name: 'Wealth Geo', icon: '🌋', basePrice: 1600, sector: 'energy', sharesOutstanding: 120000000, splitThreshold: 9600 },
};
