...
export const VERSION_PATCHES = [
  {
    version: "v2.8.2",
    date: "2026-06-11",
    title: "株式・マルチプレイ改善アップデート",
    changes: [
      "💹株式システムを修正（初期データ未生成問題を解決）",
      "💹株価を2分ごと更新に変更（9:30〜16:30のみ）",
      "💹株を購入後24時間は売却不可に変更",
      "💹株価を全プレイヤー共通でFirestore保存に変更",
      "💰️High&Lowの倍率を10連勝まで拡張",
      "💰️ギャンブル結果を30秒バッファ後にまとめてFirestore送信",
      "💰️ギャンブル速報・活動ログが正しく表示されるよう修正",
      "🗺️プレイヤー状況・ワールド状況が表示されない問題を修正",
      "🎰ジャックポットの加算率を増加",
      "✨️ミッションの一括受取機能を追加"
    ]
  },
