...
export const MONSTER_MASTER: Record<string, MonsterMaster> = {
  ...
  // 火山モンスター
  dwarf_leather:   { id:'dwarf_leather',  name:'ドワーフ[皮]',      description:'最弱のドワーフ。数は多いが単体性能は低い。ただし剛撃は最大HP依存なので油断しない。', icon:'mage', maxHp:25,  attack:6,  defense:4,  baseExp:25, baseGold:8,  dungeonIds:['volcano'], skills:['剛撃','槍投擲','薙ぎ払い'], drops:[{itemId:'forged_iron_fragment',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'volcano_mystery_item',baseRate:0.02,minAmount:1,maxAmount:1}] },
  dwarf_gold:      { id:'dwarf_gold',     name:'ドワーフ[金]',      description:'金装備ドワーフ。飛び道具を持つが、脅威はそこまで高くない。', icon:'gold', maxHp:30,  attack:1, defense:4, baseExp:30, baseGold:10, dungeonIds:['volcano'], effectiveAttack:8, skills:['120%剛撃','槍投擲','薙ぎ払い','30%ブロック'], drops:[{itemId:'faint_magic_gold_fragment',baseRate:1.0,minAmount:1,maxAmount:1}] },
  dwarf_iron:      { id:'dwarf_iron',     name:'ドワーフ[鉄]',      description:'金より少し硬い。大量湧き時に厄介になる。', icon:'pickaxe_hammer', maxHp:35,  attack:1, defense:4, baseExp:35, baseGold:12, dungeonIds:['volcano'], effectiveAttack:10, skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック'], drops:[{itemId:'magic_copper_fragment',baseRate:1.0,minAmount:1,maxAmount:1}] },
  dwarf_diamond:   { id:'dwarf_diamond',  name:'ドワーフ[ダイヤ]',  description:'カオスフレアを連打するため、群れになるとかなり危険。ダイヤ/皮装備個体の標準的な強化版として扱う。', icon:'gem', maxHp:50, attack:1, defense:4, baseExp:60, baseGold:20, dungeonIds:['volcano'], effectiveAttack:14, skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック','3連カオスフレア','ダッシュ'], drops:[{itemId:'faint_magic_gold_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'magic_copper_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'forged_iron_fragment',baseRate:0.3,minAmount:1,maxAmount:1}] },
  dwarf_crossbow_diamond: { id:'dwarf_crossbow_diamond', name:'クロスボウドワーフ[ダイヤ]', description:'4秒おきの狙撃担当。連射で視界を崩すので、群れで置くと嫌らしい。', icon:'arrow', maxHp:50, attack:1, defense:4, baseExp:65, baseGold:22, dungeonIds:['volcano'], effectiveAttack:14, skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック','3連カオスフレア','ダッシュ','火薬星'], drops:[{itemId:'faint_magic_gold_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'magic_copper_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'forged_iron_fragment',baseRate:0.3,minAmount:1,maxAmount:1}] },
  ...
  dwarf_red:       { id:'dwarf_red',      name:'ドワーフ[赤]',      description:'高火力・遠近両用の危険個体。開幕ギガブレードを含め、火山前半の要注意枠。', icon:'ore_red', maxHp:100, attack:1, defense:4, baseExp:50, baseGold:15, dungeonIds:['volcano'], effectiveAttack:28, skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック','3連カオスフレア','ダッシュ','ギガブレード'], drops:[{itemId:'magic_stone',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'empty_crossbow',baseRate:0.05,minAmount:1,maxAmount:1}] },
  dwarf_black:     { id:'dwarf_black',    name:'黒ドワーフ',        description:'火山ドワーフ最上位の危険個体。高耐久・高火力・高機動で、道中の壁役に向く。スポナー湧きではない場合は追跡圧も強い。', icon:'ore_dark', maxHp:300, attack:1, defense:4, baseExp:100,baseGold:40, dungeonIds:['volcano'], effectiveAttack:45, skills:['320%剛撃','槍投擲','薙ぎ払い','ブロック','3連カオスフレア','ダッシュ','ギガブレード','ブラッディインパクト'], drops:[{itemId:'hard_magic_stone',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'champion_sword',baseRate:0.03,minAmount:1,maxAmount:1}] },
  ...
  stain_pot:       { id:'stain_pot',      name:'ステインポット',    description:'1発で倒せるが、近づかれると極めて危険。火山序盤から終盤まで常に邪魔をする主力妨害モブ。', icon:'bomb', maxHp:1,   attack:1, defense:1,  baseExp:5,  baseGold:2,  dungeonIds:['volcano'], skills:['300%剛撃','臭気','自爆'], drops:[{itemId:'stain_pot_aura',baseRate:1.0,minAmount:1,maxAmount:1}] },
  ...
  ragnalok:        { id:'ragnalok',       name:'ラグナロク',        description:'ハンターとアサシンの嫌らしさを足したような最上位危険個体。', icon:'skull', maxHp:550, attack:75, defense:4, baseExp:200,baseGold:80, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'アサシネイション', skills:['アサシネイション','ヴェノム','爆発テレポート','即死攻撃5%','花火星','暴走射撃','カウンター射撃','トラップ設置','強制ダメージ軽減5'], traits:['出現時10秒無敵','TP時2秒無敵','属性攻撃無効','飛び道具ダメージ半減','物理半減','ブロック率100%','スポナー湧きでなく追跡してくる','基本的に複数で出る'], drops:[{itemId:'volcano_mystery_item',baseRate:0.03,minAmount:1,maxAmount:1},{itemId:'volcano_mystery_item',baseRate:0.03,minAmount:1,maxAmount:1}] },
  bannerman:       { id:'bannerman',      name:'バナーマン',        description:'周囲強化の支援役。いるだけでステインポットやドワーフ群の圧が一気に上がる。', icon:'flag', maxHp:40, attack:10, defense:20, baseExp:60, baseGold:25, dungeonIds:['volcano'], specialAttack:'闘魂奮起', skills:['闘魂奮起','ぶっ飛ばし'], drops:[{itemId:'hard_magic_stone',baseRate:0.4,minAmount:1,maxAmount:1}] },
  ...
  hunter:          { id:'hunter',         name:'ハンター',          description:'視界外から狙撃、後退、罠設置を繰り返す妨害役。近接で追い詰めても逃げられやすい。', icon:'arrow', maxHp:160, attack:1, defense:4, baseExp:55, baseGold:22, dungeonIds:['volcano'], skills:['花火星','暴走射撃','カウンター射撃','トラップ設置','強制ダメージ軽減1'], drops:[{itemId:'empty_crossbow_hunter',baseRate:1.0,minAmount:1,maxAmount:1}] },
  ...
  assassin:        { id:'assassin',       name:'アサシン',          description:'追跡・瞬間火力・罠設置を兼ねる暗殺型。近距離での事故率が高い。', icon:'dagger', maxHp:160, attack:75, defense:20, baseExp:120, baseGold:50, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'アサシネイション', skills:['アサシネイション','ヴェノム','爆発テレポート','トラップ設置','強制ダメージ軽減1','即死攻撃1%'], drops:[{itemId:'assassin_used_knife',baseRate:0.1,minAmount:1,maxAmount:1}] },
  defender:        { id:'defender',       name:'ディフェンサー',    description:'直接の火力より、視点妨害で事故を誘発する。ステインポット、アルケミストと組み合わさると非常に面倒。', icon:'shield', maxHp:300, attack:75, defense:20, baseExp:80, baseGold:35, dungeonIds:['volcano'], specialAttack:'視点変更', skills:['視点変更'], drops:[{itemId:'guardian_armor',baseRate:0.4,minAmount:1,maxAmount:1}] },
  ...
  alchemist:       { id:'alchemist',      name:'アルケミスト',      description:'毒・鈍足・盲目系の妨害役。被弾すると回復し始めるため、一気に倒すのが重要。', icon:'potion', maxHp:50, attack:5, defense:20, baseExp:50, baseGold:20, dungeonIds:['volcano'], specialAttack:'デバフポーション投げ', skills:['デバフポーション投げ'], drops:[{itemId:'alchemist_medicine',baseRate:1.0,minAmount:1,maxAmount:1}] },
  evil_summoner:   { id:'evil_summoner',  name:'エビルサマナー',    description:'召喚で盤面を壊すタイプ。火山の敵密度を一気に押し上げる。召喚候補：ドワーフ[鉄]・ドワーフ[ダイヤ]・ドワーフ[赤]・ステインポット・ステインキッド・アサシン軍団・ラグナロク・BUSTER。', icon:'skull', maxHp:100, attack:30, defense:10, baseExp:60, baseGold:25, dungeonIds:['volcano'], specialAttack:'サモンボルケーノ', skills:['サモンボルケーノ'], drops:[{itemId:'evil_summoner_staff',baseRate:1.0,minAmount:1,maxAmount:1}] },
  hell_summoner:   { id:'hell_summoner',  name:'ヘルサマナー',      description:'裏火山の超危険召喚士。人口太陽は広範囲即死級なので、接敵設計に注意する。追加召喚：ブルートゾンビ・スカウト・バナーマン。', icon:'skull', maxHp:400, attack:30, defense:10, baseExp:200, baseGold:100, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'人口太陽', skills:['サモンボルケーノ','人口太陽'], drops:[{itemId:'evil_summoner_staff',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'abyss_riverbank',baseRate:0.05,minAmount:1,maxAmount:1}] },
  danger_crown:    { id:'danger_crown',   name:'デンジャークラウン', description:'ラグナロクとは別方向の危険モブ。召喚・視点妨害・反射系で立て直しを阻む。', icon:'crown', maxHp:550, attack:75, defense:4, baseExp:180, baseGold:70, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'カウンター・オブ・デンジャークラウン', skills:['視点変更','サモンボルケーノ','デバフポーション投げ','カウンター・オブ・デンジャークラウン'], traits:['属性攻撃無効','飛び道具ダメージ半減','強制ダメージ軽減1'], drops:[{itemId:'volcano_mystery_item',baseRate:0.03,minAmount:1,maxAmount:1},{itemId:'evil_summoner_staff',baseRate:1.0,minAmount:1,maxAmount:1}] },
  ...
  scout:           { id:'scout',          name:'スカウト',          description:'火山裏側で初登場する高火力の厄介者。近接で殴り合うと非常に危険。', icon:'arrow', maxHp:255, attack:200, defense:4, baseExp:90, baseGold:40, dungeonIds:['volcano'], specialAttack:'320%剛撃', skills:['320%剛撃','ファイアチップ','ファイアウェーブ','3連カオスフレア','ブラッディインパクト','ぶっ飛ばし'], drops:[] },
  ...
  volcano: {
    ...
    routes: {
      ...
      back: [
        ...
        {
          name:'裏火山城・最上階',
          description:'特に何もないので奥に進み獄炎帝と戦え。12秒間隔のスキルローテーションで攻撃と召喚を使い分ける規格外のタフネスを誇る最終関門。近づかず遠距離主体で削るのが定石とされる。倒すと、立ち回りは同一ながらスキル間隔が7秒に短縮された真のラスボス・絶炎帝が出現する。ただしボスより道中を本体として設計されたダンジョン——ここまで来れたなら実力は本物だ。',
          monsters:[
