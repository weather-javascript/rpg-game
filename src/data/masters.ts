...
export const MONSTER_MASTER: Record<string, MonsterMaster> = {
  ...
  dwarf_gold:      { id:'dwarf_gold',     name:'ドワーフ[金]',      description:'金装備ドワーフ。飛び道具を持つが、脅威はそこまで高くない。', icon:'gold', maxHp:30,  attack:1, defense:4, baseExp:30, baseGold:10, dungeonIds:['volcano'], skills:['120%剛撃','槍投擲','薙ぎ払い','30%ブロック'], drops:[{itemId:'faint_magic_gold_fragment',baseRate:1.0,minAmount:1,maxAmount:1}] },
  dwarf_iron:      { id:'dwarf_iron',     name:'ドワーフ[鉄]',      description:'金より少し硬い。大量湧き時に厄介になる。', icon:'pickaxe_hammer', maxHp:35,  attack:1, defense:4, baseExp:35, baseGold:12, dungeonIds:['volcano'], skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック'], drops:[{itemId:'magic_copper_fragment',baseRate:1.0,minAmount:1,maxAmount:1}] },
  dwarf_diamond:   { id:'dwarf_diamond',  name:'ドワーフ[ダイヤ]',  description:'カオスフレアを連打するため、群れになるとかなり危険。ダイヤ/皮装備個体の標準的な強化版として扱う。', icon:'gem', maxHp:50, attack:1, defense:4, baseExp:60, baseGold:20, dungeonIds:['volcano'], skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック','3連カオスフレア','ダッシュ'], drops:[{itemId:'faint_magic_gold_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'magic_copper_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'forged_iron_fragment',baseRate:0.3,minAmount:1,maxAmount:1}] },
  dwarf_crossbow_diamond: { id:'dwarf_crossbow_diamond', name:'クロスボウドワーフ[ダイヤ]', description:'4秒おきの狙撃担当。連射で視界を崩すので、群れで置くと嫌らしい。', icon:'arrow', maxHp:50, attack:1, defense:4, baseExp:65, baseGold:22, dungeonIds:['volcano'], skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック','3連カオスフレア','ダッシュ','火薬星'], drops:[{itemId:'faint_magic_gold_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'magic_copper_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'forged_iron_fragment',baseRate:0.3,minAmount:1,maxAmount:1}] },
  ...
  dwarf_red:       { id:'dwarf_red',      name:'ドワーフ[赤]',      description:'高火力・遠近両用の危険個体。開幕ギガブレードを含め、火山前半の要注意枠。', icon:'ore_red', maxHp:100, attack:1, defense:4, baseExp:50, baseGold:15, dungeonIds:['volcano'], skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック','3連カオスフレア','ダッシュ','ギガブレード'], drops:[{itemId:'magic_stone',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'empty_crossbow',baseRate:0.05,minAmount:1,maxAmount:1}] },
  dwarf_black:     { id:'dwarf_black',    name:'黒ドワーフ',        description:'火山ドワーフ最上位の危険個体。高耐久・高火力・高機動で、道中の壁役に向く。スポナー湧きではない場合は追跡圧も強い。', icon:'ore_dark', maxHp:300, attack:1, defense:4, baseExp:100,baseGold:40, dungeonIds:['volcano'], skills:['320%剛撃','槍投擲','薙ぎ払い','ブロック','3連カオスフレア','ダッシュ','ギガブレード','ブラッディインパクト'], drops:[{itemId:'hard_magic_stone',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'champion_sword',baseRate:0.03,minAmount:1,maxAmount:1}] },
