...
export const ITEM_MASTER: Record<string, ItemMaster> = {
  ...
  // ============================================================
  emerald_sword:  { id:'emerald_sword',  name:'エメラルドの剣', description:'エメラルドから作れる剣。攻撃力+9。', category:'weapon', itemType:'Weapon', rarity:'epic',     sellPrice:900,  buyPrice:0, maxStack:1, icon:'emerald_sword_png',   useEffect:{attackBonus:9,  message:'エメラルドの剣で斬りつけた！', attackType:'physical'} },
  netherite_sword:{ id:'netherite_sword',name:'ネザライトの剣', description:'ネザライトインゴットから作れる剣。攻撃力+10。', category:'weapon', itemType:'Weapon', rarity:'legendary', sellPrice:1200, buyPrice:0, maxStack:1, icon:'netherite_sword_png', useEffect:{attackBonus:10, message:'ネザライトの剣で斬りつけた！', attackType:'physical'} },
  iron_sacrifice_staff:      { id:'iron_sacrifice_staff',      name:'アイアンサクリファイス',     description:'鉄の剣と圧縮鉄ブロックから作られた杖。範囲攻撃貫通8。',         category:'weapon', itemType:'Weapon', rarity:'rare',      sellPrice:1500,   buyPrice:0, maxStack:1, icon:'wand', isAreaWeapon:true, areaPenetrate:8,  useEffect:{attackBonus:0, message:'アイアンサクリファイスで全体攻撃！', attackType:'area'} },
  gold_sacrifice_staff:      { id:'gold_sacrifice_staff',      name:'ゴールドサクリファイス',     description:'金の剣と圧縮金ブロックから作られた杖。範囲攻撃貫通10。',       category:'weapon', itemType:'Weapon', rarity:'rare',      sellPrice:3000,   buyPrice:0, maxStack:1, icon:'wand', isAreaWeapon:true, areaPenetrate:10, useEffect:{attackBonus:0, message:'ゴールドサクリファイスで全体攻撃！', attackType:'area'} },
  diamond_sacrifice_staff:   { id:'diamond_sacrifice_staff',   name:'ダイヤモンドサクリファイス', description:'ダイヤの剣と圧縮ダイヤブロックから作られた杖。範囲攻撃貫通14。', category:'weapon', itemType:'Weapon', rarity:'epic',      sellPrice:8000,   buyPrice:0, maxStack:1, icon:'wand', isAreaWeapon:true, areaPenetrate:14, useEffect:{attackBonus:0, message:'ダイヤモンドサクリファイスで全体攻撃！', attackType:'area'} },
  emerald_sacrifice_staff:   { id:'emerald_sacrifice_staff',   name:'エメラルドサクリファイス',   description:'エメラルドの剣と圧縮エメラルドブロックから作られた杖。範囲攻撃貫通17。', category:'weapon', itemType:'Weapon', rarity:'epic',      sellPrice:15000,  buyPrice:0, maxStack:1, icon:'wand', isAreaWeapon:true, areaPenetrate:17, useEffect:{attackBonus:0, message:'エメラルドサクリファイスで全体攻撃！', attackType:'area'} },
  netherite_sacrifice_staff: { id:'netherite_sacrifice_staff', name:'ネザライトサクリファイス',   description:'ネザライトの剣と圧縮ネザライトブロックから作られた杖。範囲攻撃貫通25。', category:'weapon', itemType:'Weapon', rarity:'legendary', sellPrice:100000, buyPrice:0, maxStack:1, icon:'wand', isAreaWeapon:true, areaPenetrate:25, useEffect:{attackBonus:0, message:'ネザライトサクリファイスで全体攻撃！', attackType:'area'} },
  // モンスタードロップ
