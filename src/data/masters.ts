...
export const MONSTER_MASTER: Record<string, MonsterMaster> = {
  ...
  // 火山モンスター
  dwarf_leather:   { id:'dwarf_leather',  name:'ドワーフ[皮]',      description:'最弱のドワーフ。数は多いが単体性能は低い。ただし剛撃は最大HP依存なので油断しない。', icon:'mage', maxHp:25,  attack:6,  defense:6,  baseExp:25, baseGold:8,  dungeonIds:['volcano'], effectiveAttack:9, skills:['剛撃','槍投擲','薙ぎ払い'], drops:[{itemId:'forged_iron_fragment',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'volcano_mystery_item',baseRate:0.02,minAmount:1,maxAmount:1}] },
  dwarf_gold:      { id:'dwarf_gold',     name:'ドワーフ[金]',      description:'金装備ドワーフ。飛び道具を持つが、脅威はそこまで高くない。', icon:'gold', maxHp:35,  attack:1, defense:6, baseExp:30, baseGold:10, dungeonIds:['volcano'], effectiveAttack:12, skills:['120%剛撃','槍投擲','薙ぎ払い','30%ブロック'], drops:[{itemId:'faint_magic_gold_fragment',baseRate:1.0,minAmount:1,maxAmount:1}] },
  dwarf_iron:      { id:'dwarf_iron',     name:'ドワーフ[鉄]',      description:'金より少し硬い。大量湧き時に厄介になる。', icon:'pickaxe_hammer', maxHp:45,  attack:1, defense:6, baseExp:35, baseGold:12, dungeonIds:['volcano'], effectiveAttack:15, skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック'], drops:[{itemId:'magic_copper_fragment',baseRate:1.0,minAmount:1,maxAmount:1}] },
  dwarf_diamond:   { id:'dwarf_diamond',  name:'ドワーフ[ダイヤ]',  description:'カオスフレアを連打するため、群れになるとかなり危険。ダイヤ/皮装備個体の標準的な強化版として扱う。', icon:'gem', maxHp:65, attack:1, defense:6, baseExp:60, baseGold:20, dungeonIds:['volcano'], effectiveAttack:20, skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック','3連カオスフレア','ダッシュ'], drops:[{itemId:'faint_magic_gold_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'magic_copper_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'forged_iron_fragment',baseRate:0.3,minAmount:1,maxAmount:1}] },
  dwarf_crossbow_diamond: { id:'dwarf_crossbow_diamond', name:'クロスボウドワーフ[ダイヤ]', description:'4秒おきの狙撃担当。連射で視界を崩すので、群れで置くと嫌らしい。', icon:'arrow', maxHp:65, attack:1, defense:6, baseExp:65, baseGold:22, dungeonIds:['volcano'], effectiveAttack:20, skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック','3連カオスフレア','ダッシュ','火薬星'], drops:[{itemId:'faint_magic_gold_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'magic_copper_fragment',baseRate:0.3,minAmount:1,maxAmount:1},{itemId:'forged_iron_fragment',baseRate:0.3,minAmount:1,maxAmount:1}] },
  dwarf_crossbow:  { id:'dwarf_crossbow', name:'ドワーフ[クロスボウ]', description:'遠距離攻撃専門のドワーフ。溶岩上から狙撃する。', icon:'arrow', maxHp:65, attack:19, defense:6, baseExp:28, baseGold:10, dungeonIds:['volcano'], drops:[{itemId:'dwarf_fragment',baseRate:1.0,minAmount:1,maxAmount:2},{itemId:'magma_stone',baseRate:0.4,minAmount:1,maxAmount:1}] },
  dwarf_red:       { id:'dwarf_red',      name:'ドワーフ[赤]',      description:'高火力・遠近両用の危険個体。開幕ギガブレードを含め、火山前半の要注意枠。', icon:'ore_red', maxHp:110, attack:1, defense:6, baseExp:50, baseGold:15, dungeonIds:['volcano'], effectiveAttack:36, skills:['160%剛撃','槍投擲','薙ぎ払い','50%ブロック','3連カオスフレア','ダッシュ','ギガブレード'], drops:[{itemId:'magic_stone',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'empty_crossbow',baseRate:0.05,minAmount:1,maxAmount:1}] },
  dwarf_black:     { id:'dwarf_black',    name:'黒ドワーフ',        description:'火山ドワーフ最上位の危険個体。高耐久・高火力・高機動で、道中の壁役に向く。スポナー湧きではない場合は追跡圧も強い。', icon:'ore_dark', maxHp:340, attack:1, defense:8, baseExp:100,baseGold:40, dungeonIds:['volcano'], effectiveAttack:56, skills:['320%剛撃','槍投擲','薙ぎ払い','ブロック','3連カオスフレア','ダッシュ','ギガブレード','ブラッディインパクト'], drops:[{itemId:'hard_magic_stone',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'champion_sword',baseRate:0.03,minAmount:1,maxAmount:1}] },
  dwarf_ancient:   { id:'dwarf_ancient',  name:'エンシェントドワーフ', description:'古代種の強力なドワーフ。大橋地帯に配置される守護者。', icon:'ore_dark', maxHp:300, attack:42, defense:24, baseExp:180, baseGold:70, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'古代の怒り', drops:[{itemId:'hard_magic_stone',baseRate:1.0,minAmount:2,maxAmount:3},{itemId:'magma_stone',baseRate:1.0,minAmount:3,maxAmount:5}] },
  dwarf_ancient_awakened: { id:'dwarf_ancient_awakened', name:'[覚醒]エンシェントドワーフ', description:'力を解放した古代ドワーフ。裏火山城1階に潜む。', icon:'ore_dark', maxHp:340, attack:48, defense:26, baseExp:220, baseGold:90, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'覚醒の業火', drops:[{itemId:'hard_magic_stone',baseRate:1.0,minAmount:2,maxAmount:4},{itemId:'magma_stone',baseRate:1.0,minAmount:3,maxAmount:6}] },
  stain_pot:       { id:'stain_pot',      name:'ステインポット',    description:'1発で倒せるが、近づかれると極めて危険。火山序盤から終盤まで常に邪魔をする主力妨害モブ。', icon:'bomb', maxHp:1,   attack:1, defense:1,  baseExp:5,  baseGold:2,  dungeonIds:['volcano'], effectiveAttack:38, skills:['300%剛撃','臭気','自爆'], drops:[{itemId:'stain_pot_aura',baseRate:1.0,minAmount:1,maxAmount:1}] },
  ...
  ragnalok:        { id:'ragnalok',       name:'ラグナロク',        description:'ハンターとアサシンの嫌らしさを足したような最上位危険個体。複数体で追跡・狙撃・テレポート奇襲を仕掛けてくるため、群れの中で放置すると一気に体力を持っていかれる。', icon:'skull', maxHp:600, attack:80, defense:6, baseExp:200,baseGold:80, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'アサシネイション', skills:['アサシネイション(高火力急襲)','ヴェノム(継続毒)','爆発テレポート(着地点に爆風)','即死攻撃5%','花火星(範囲牽制)','暴走射撃(連続遠隔攻撃)','カウンター射撃','トラップ設置(踏むと足止め)','強制ダメージ軽減5'], traits:['出現時10秒無敵','TP時2秒無敵','属性攻撃無効','飛び道具ダメージ半減','物理半減','ブロック率100%','スポナー湧きでなく追跡してくる','基本的に複数で出る'], drops:[{itemId:'volcano_mystery_item',baseRate:0.03,minAmount:1,maxAmount:1},{itemId:'volcano_mystery_item',baseRate:0.03,minAmount:1,maxAmount:1}] },
  bannerman:       { id:'bannerman',      name:'バナーマン',        description:'周囲強化の支援役。範囲内の味方の攻撃力を底上げするため、最優先で潰さないとステインポットやドワーフ群の圧が雪だるま式に増す。', icon:'flag', maxHp:55, attack:14, defense:22, baseExp:60, baseGold:25, dungeonIds:['volcano'], specialAttack:'闘魂奮起', skills:['闘魂奮起(周囲の敵攻撃力+25%)','ぶっ飛ばし'], drops:[{itemId:'hard_magic_stone',baseRate:0.4,minAmount:1,maxAmount:1}] },
  lumberjack:      { id:'lumberjack',     name:'ランバージャック',  description:'闇森から流れ込んだ木こり型の強敵。', icon:'sword', maxHp:150, attack:26, defense:10, baseExp:70, baseGold:30, dungeonIds:['volcano'], drops:[{itemId:'dwarf_fragment',baseRate:0.8,minAmount:1,maxAmount:2}] },
  hunter:          { id:'hunter',         name:'ハンター',          description:'視界外から狙撃、後退、罠設置を繰り返す妨害役。連射と罠で少しずつ削ってくるため、群れの中で放置すると気づかぬ間にHPを失う遠距離圧力役。優先的に詰めて沈黙させたい。', icon:'arrow', maxHp:170, attack:1, defense:6, baseExp:55, baseGold:22, dungeonIds:['volcano'], effectiveAttack:24, skills:['花火星(範囲牽制)','暴走射撃(3連射)','カウンター射撃','トラップ設置(踏むと足止め)','強制ダメージ軽減1'], drops:[{itemId:'empty_crossbow_hunter',baseRate:1.0,minAmount:1,maxAmount:1}] },
  hunter_trainee:  { id:'hunter_trainee', name:'見習いハンター',   description:'ハンターの下位互換。単体の脅威は低いが、数で押し寄せると遠距離弾幕になる。', icon:'arrow', maxHp:65, attack:18, defense:4, baseExp:30, baseGold:12, dungeonIds:['volcano'], skills:['牽制射撃'], drops:[{itemId:'dwarf_fragment',baseRate:0.3,minAmount:1,maxAmount:1}] },
  assassin:        { id:'assassin',       name:'アサシン',          description:'追跡・瞬間火力・罠設置を兼ねる暗殺型。近距離での事故率が高い。', icon:'dagger', maxHp:175, attack:82, defense:22, baseExp:120, baseGold:50, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'アサシネイション', skills:['アサシネイション','ヴェノム','爆発テレポート','トラップ設置','強制ダメージ軽減1','即死攻撃1%'], drops:[{itemId:'assassin_used_knife',baseRate:0.1,minAmount:1,maxAmount:1}] },
  defender:        { id:'defender',       name:'ディフェンサー',    description:'直接の火力より、視点妨害で事故を誘発する。ステインポット、アルケミストと組み合わさると非常に面倒。', icon:'shield', maxHp:320, attack:78, defense:24, baseExp:80, baseGold:35, dungeonIds:['volcano'], specialAttack:'視点変更', skills:['視点変更'], drops:[{itemId:'guardian_armor',baseRate:0.4,minAmount:1,maxAmount:1}] },
  super_defender:  { id:'super_defender', name:'スーパーディフェンサー', description:'ディフェンサーの上位種。被ダメージ70%カットの硬い壁として通路を塞ぎ、後続の召喚役やラグナロクが安全に攻撃できる時間を作る。貫通攻撃で壁を崩さない限り長期戦は避けられない。', icon:'shield', maxHp:380, attack:26, defense:55, baseExp:160, baseGold:65, dungeonIds:['volcano'], isMidBoss:true, defensePct:0.7, specialAttack:'鉄壁の盾', skills:['鉄壁の盾(被ダメージ70%カット)','視点変更'], drops:[{itemId:'hard_magic_stone',baseRate:1.0,minAmount:1,maxAmount:2}] },
  alchemist:       { id:'alchemist',      name:'アルケミスト',      description:'毒・鈍足・盲目系の妨害役。被弾すると回復し始めるため、一気に倒すのが重要。視界デバフを撒かれた状態で他の敵に囲まれると一気に崩れる。', icon:'potion', maxHp:60, attack:9, defense:22, baseExp:50, baseGold:20, dungeonIds:['volcano'], specialAttack:'デバフポーション投げ', skills:['デバフポーション投げ(毒/鈍足/盲目)'], drops:[{itemId:'alchemist_medicine',baseRate:1.0,minAmount:1,maxAmount:1}] },
  evil_summoner:   { id:'evil_summoner',  name:'エビルサマナー',    description:'召喚で盤面を壊すタイプ。放置するとドワーフやステインポットを次々召喚し続け、火山の敵密度を一気に押し上げる。最優先撃破推奨。召喚候補：ドワーフ[鉄]・ドワーフ[ダイヤ]・ドワーフ[赤]・ステインポット・ステインキッド・アサシン軍団・ラグナロク・BUSTER。', icon:'skull', maxHp:110, attack:34, defense:12, baseExp:60, baseGold:25, dungeonIds:['volcano'], specialAttack:'サモンボルケーノ', skills:['サモンボルケーノ(短間隔で雑魚2〜3体を追加召喚し続ける)'], drops:[{itemId:'evil_summoner_staff',baseRate:1.0,minAmount:1,maxAmount:1}] },
  hell_summoner:   { id:'hell_summoner',  name:'ヘルサマナー',      description:'裏火山の超危険召喚士。人口太陽は広範囲即死級なので、接敵設計に注意する。サモンボルケーノも併用するため、放置すると召喚物が雪だるま式に増えていく。追加召喚：ブルートゾンビ・スカウト・バナーマン。', icon:'skull', maxHp:420, attack:32, defense:12, baseExp:200, baseGold:100, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'人口太陽', skills:['サモンボルケーノ(雑魚を連続召喚)','人口太陽(15×15貫通5555即死・近づかず処理推奨)'], drops:[{itemId:'evil_summoner_staff',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'abyss_riverbank',baseRate:0.05,minAmount:1,maxAmount:1}] },
  danger_crown:    { id:'danger_crown',   name:'デンジャークラウン', description:'ラグナロクとは別方向の危険モブ。召喚・視点妨害・カウンター反射で立て直しを阻む。複数体で出ると視点を乱されながら召喚モブにも対処する必要があり、対応を誤ると一気に崩れる。', icon:'crown', maxHp:580, attack:78, defense:6, baseExp:180, baseGold:70, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'カウンター・オブ・デンジャークラウン', skills:['視点変更','サモンボルケーノ(雑魚召喚)','デバフポーション投げ(毒/鈍足/盲目)','カウンター・オブ・デンジャークラウン(被弾時反射)'], traits:['属性攻撃無効','飛び道具ダメージ半減','強制ダメージ軽減1'], drops:[{itemId:'volcano_mystery_item',baseRate:0.03,minAmount:1,maxAmount:1},{itemId:'evil_summoner_staff',baseRate:1.0,minAmount:1,maxAmount:1}] },
  ...
  green_beret:     { id:'green_beret',    name:'グリーンベレー',    description:'精鋭部隊の一員。しっかり処理しないとその先が面倒になる。', icon:'shield', maxHp:220, attack:34, defense:17, baseExp:140, baseGold:55, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'精鋭突撃', drops:[{itemId:'hard_magic_stone',baseRate:0.8,minAmount:1,maxAmount:2}] },
  scout:           { id:'scout',          name:'スカウト',          description:'火山裏側で初登場する高火力の厄介者。近接で殴り合うと非常に危険。', icon:'arrow', maxHp:270, attack:200, defense:6, baseExp:90, baseGold:40, dungeonIds:['volcano'], specialAttack:'320%剛撃', skills:['320%剛撃','ファイアチップ','ファイアウェーブ','3連カオスフレア','ブラッディインパクト','ぶっ飛ばし'], drops:[] },
  suppression_squad: { id:'suppression_squad', name:'鎮圧戦隊',  description:'組織的に動く精鋭部隊。倒すのに時間がかかると黒ドワーフが増援に来る。Vortex Hurricaneで奈落落としが効果的。', icon:'shield', maxHp:175, attack:28, defense:22, baseExp:120, baseGold:50, dungeonIds:['volcano'], specialAttack:'組織的包囲', drops:[{itemId:'hard_magic_stone',baseRate:0.7,minAmount:1,maxAmount:2}] },
  seal_god:        { id:'seal_god',       name:'封印邪神',          description:'攻撃の余波でTPしてくるが、特攻しない限りは無害。無視安定。', icon:'gem', maxHp:520, attack:82, defense:32, baseExp:300, baseGold:150, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'邪神の封印', drops:[{itemId:'hard_magic_stone',baseRate:1.0,minAmount:2,maxAmount:4}] },
  blue_zombie:     { id:'blue_zombie',    name:'ブルーゾンビ',      description:'青い死霊。単体では大したことないが集団で来ると面倒。', icon:'skull', maxHp:130, attack:24, defense:9, baseExp:70, baseGold:30, dungeonIds:['volcano'], drops:[{itemId:'magma_stone',baseRate:0.5,minAmount:1,maxAmount:2}] },
  ryuma:           { id:'ryuma',          name:'リューマ',          description:'HPが減るほど危険になる中ボス。後半ほど範囲攻撃前提になる。', icon:'sword', maxHp:2250, attack:75, defense:30, baseExp:130, baseGold:55, dungeonIds:['volcano'], specialAttack:'アトミック閃', skills:['アトミック閃','スライスカウンター','逆境'], drops:[{itemId:'ryuma_tanto',baseRate:0.99,minAmount:1,maxAmount:1}] },
  izo:             { id:'izo',            name:'以蔵',              description:'距離を取ると比較的楽だが、張り付かれると危険。', icon:'dagger', maxHp:2250, attack:75, defense:30, baseExp:130, baseGold:55, dungeonIds:['volcano'], specialAttack:'爪装乱舞', skills:['爪装乱舞','スライスカウンター'], drops:[{itemId:'ancient_forged_iron',baseRate:0.99,minAmount:1,maxAmount:1}] },
  destroyer:       { id:'destroyer',      name:'デストロイヤー',    description:'飛び道具主体の高火力モブ。エフェクトと当たり判定が強く、正面からの処理が難しい。', icon:'ore_dark', maxHp:2250, attack:75, defense:30, baseExp:140, baseGold:60, dungeonIds:['volcano'], specialAttack:'超元気な玉', skills:['16連拳','波動砲','波動弾','超元気な玉','飛鳥文化アタック'], drops:[{itemId:'destroyer_qi',baseRate:0.99,minAmount:1,maxAmount:1}] },
