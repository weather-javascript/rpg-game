...
export const ITEM_MASTER: Record<string, ItemMaster> = {
  ...
  ancient_shard:{ id:'ancient_shard', name:'古代の欠片', description:'ダンジョンの深部に眠る謎の素材。', category:'material', rarity:'epic', sellPrice:500, buyPrice:0, maxStack:99, icon:'gem' },
  ...
  dragon_scale:    { id:'dragon_scale',     name:'ドラゴンの鱗', description:'非常に希少な最高素材。',   category:'material', rarity:'legendary',sellPrice:2000,buyPrice:0, maxStack:10, icon:'dragon' },
  // 火山ドロップ
...
export const GAMBLE_MASTER: Record<string, GambleMaster> = {
  ...
  treasure_box: {
    ...
    icon:'box', type:'treasure_box', minBet:100, maxBet:100, returnRate:0.92,
    rewardTable:[
