...
export const MONSTER_MASTER: Record<string, MonsterMaster> = {
  ...
  ragnalok:        { id:'ragnalok',       name:'ラグナロク',        description:'ハンターとアサシンの嫌らしさを足したような最上位危険個体。', icon:'skull', maxHp:600, attack:80, defense:6, baseExp:200,baseGold:80, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'アサシネイション', skills:['アサシネイション','ヴェノム','爆発テレポート','即死攻撃5%','花火星','暴走射撃','カウンター射撃','トラップ設置','強制ダメージ軽減5'], traits:['出現時10秒無敵','TP時2秒無敵','属性攻撃無効','飛び道具ダメージ半減','物理半減','ブロック率100%','スポナー湧きでなく追跡してくる','基本的に複数で出る'], drops:[{itemId:'volcano_mystery_item',baseRate:0.03,minAmount:1,maxAmount:1},{itemId:'volcano_mystery_item',baseRate:0.03,minAmount:1,maxAmount:1}] },
  ...
  hunter:          { id:'hunter',         name:'ハンター',          description:'視界外から狙撃、後退、罠設置を繰り返す妨害役。放置すると遠距離からじわじわ削られ続けるため、群れの中では優先して処理したい遠距離圧力役。', icon:'arrow', maxHp:170, attack:1, defense:6, baseExp:55, baseGold:22, dungeonIds:['volcano'], effectiveAttack:24, skills:['花火星','暴走射撃','カウンター射撃','トラップ設置','強制ダメージ軽減1'], drops:[{itemId:'empty_crossbow_hunter',baseRate:1.0,minAmount:1,maxAmount:1}] },
  hunter_trainee:  { id:'hunter_trainee', name:'見習いハンター',   description:'ハンターの下位互換。無視安定だが数が多い。', icon:'arrow', maxHp:65, attack:18, defense:4, baseExp:30, baseGold:12, dungeonIds:['volcano'], drops:[{itemId:'dwarf_fragment',baseRate:0.3,minAmount:1,maxAmount:1}] },
  ...
  super_defender:  { id:'super_defender', name:'スーパーディフェンサー', description:'ディフェンサーの上位種。更に硬い壁として立ちはだかる。貫通攻撃推奨。', icon:'shield', maxHp:380, attack:26, defense:55, baseExp:160, baseGold:65, dungeonIds:['volcano'], isMidBoss:true, defensePct:0.7, specialAttack:'鉄壁の盾', drops:[{itemId:'hard_magic_stone',baseRate:1.0,minAmount:1,maxAmount:2}] },
  ...
  evil_summoner:   { id:'evil_summoner',  name:'エビルサマナー',    description:'召喚で盤面を壊すタイプ。放置するとドワーフやステインポットを次々召喚し続け、火山の敵密度を一気に押し上げる。最優先撃破推奨。召喚候補：ドワーフ[鉄]・ドワーフ[ダイヤ]・ドワーフ[赤]・ステインポット・ステインキッド・アサシン軍団・ラグナロク・BUSTER。', icon:'skull', maxHp:110, attack:34, defense:12, baseExp:60, baseGold:25, dungeonIds:['volcano'], specialAttack:'サモンボルケーノ', skills:['サモンボルケーノ(数ターン毎に雑魚を召喚)'], drops:[{itemId:'evil_summoner_staff',baseRate:1.0,minAmount:1,maxAmount:1}] },
  hell_summoner:   { id:'hell_summoner',  name:'ヘルサマナー',      description:'裏火山の超危険召喚士。人口太陽は広範囲即死級なので、接敵設計に注意する。追加召喚：ブルートゾンビ・スカウト・バナーマン。', icon:'skull', maxHp:420, attack:32, defense:12, baseExp:200, baseGold:100, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'人口太陽', skills:['サモンボルケーノ','人口太陽'], drops:[{itemId:'evil_summoner_staff',baseRate:1.0,minAmount:1,maxAmount:1},{itemId:'abyss_riverbank',baseRate:0.05,minAmount:1,maxAmount:1}] },
  danger_crown:    { id:'danger_crown',   name:'デンジャークラウン', description:'ラグナロクとは別方向の危険モブ。召喚・視点妨害・反射系で立て直しを阻む。', icon:'crown', maxHp:580, attack:78, defense:6, baseExp:180, baseGold:70, dungeonIds:['volcano'], isMidBoss:true, specialAttack:'カウンター・オブ・デンジャークラウン', skills:['視点変更','サモンボルケーノ','デバフポーション投げ','カウンター・オブ・デンジャークラウン'], traits:['属性攻撃無効','飛び道具ダメージ半減','強制ダメージ軽減1'], drops:[{itemId:'volcano_mystery_item',baseRate:0.03,minAmount:1,maxAmount:1},{itemId:'evil_summoner_staff',baseRate:1.0,minAmount:1,maxAmount:1}] },
