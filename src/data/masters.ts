...
export const CRAFT_RECIPES: CraftRecipe[] = [
  ...
  },
  {
    id: 'cave_staff_craft',
    name: '洞窟の杖を作る',
    description: '洞窟王の宝石64個から範囲攻撃杖を作る。貫通10。',
    outputItemId: 'cave_staff',
    outputAmount: 1,
    inputs: [{ itemId: 'cave_gem', amount: 64 }],
    shape: ['cave_gem','cave_gem','cave_gem', 'cave_gem','cave_gem','cave_gem', 'cave_gem','cave_gem','cave_gem'],
    requiredCraftingLevel: 25,
    craftingExpGain: 500,
  },
  {
    id: 'cave_staff2_craft',
    name: '岩窟の杖を作る',
    description: '洞窟の杖とモグラの爪から上位の範囲攻撃杖を作る。貫通20。',
    outputItemId: 'cave_staff2',
    outputAmount: 1,
    inputs: [{ itemId: 'cave_staff', amount: 1 }, { itemId: 'mole_claw', amount: 4 }],
    shape: ['mole_claw','cave_staff','mole_claw', 'mole_claw','','mole_claw', '','',''],
