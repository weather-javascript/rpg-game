...
const DEFAULT_TRADE_RECIPES: TradeRecipe[] = [
  ...
  {
    id: 'trade_gyouen_no_ken',
    name: '=業炎の剣=と交換',
    description: 'ネザライトインゴット16個、魂の炎4個、強固な骨1個を納めると=業炎の剣=と交換してもらえる。',
    inputs: [{ itemId: 'netherite_ingot', amount: 16 }, { itemId: 'soul_flame', amount: 4 }, { itemId: 'solid_bone', amount: 1 }],
